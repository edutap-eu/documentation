...
Vault
    A digital vault is a large secure date store. It is derived from the term vault that describes a secure room or rooms in or below a bank used to store valuables. The noun safe or safe-deposit box, describing a box, usually made of metal, fireproof, in which personal valuables can be locked for safekeeping is related term.
